...
// 시너지 비보유 유닛의 공격력에 spellPower Flat 수정자를 적용한다.
...
{
    /// <summary>
    /// 비전 마법사 시너지의 부수 효과. 비보유 유닛에 spellPower 값의 공격력 Flat 수정자를 적용한다.
    ...
    public class ArcanistSpellPowerEffect : TierLinkedStatusEffect<TierLinkedStatusEffectContext>
    {
        ...
        {
            TierContext.Unit.StatSheet.Attack.RemoveModifiersBySource(this);
        }
    }
}