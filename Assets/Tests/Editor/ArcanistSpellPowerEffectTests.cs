...
{
    /// <summary>
    /// ArcanistSpellPowerEffect(비전 마법사 부수 효과)의 Attack Flat 수정자 적용/갱신/해제를 검증한다.
    /// </summary>
    public class ArcanistSpellPowerEffectTests
    {
        ...
        [Test]
        public void OnTierActivated_AddsFlatModifierToAttack()
        {
        ...
        public void OnTierChanged_UpdatesModifierValue()
        {
            ...
            float expected = BaseAttack + Tier2SpellPower;
            Assert.AreEqual(expected, _unit.StatSheet.Attack.CurrentValue, 0.01f);
        }
